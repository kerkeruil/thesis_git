...
#   as well. This is to prevent that categories generated in for example round two aren't immediately used for generating. 
    ...
    for depth in range(depth): 
        ...
        for name_d, matrix_d, score_d in concepts:
            ...
            name_inv = [name_d, name_d]
            name_symm_clos = [name_d, name_d]
            name_tran_clos = [name_d, name_d]
            score = 1 + score_d
        ...
        for name_s, matrix_s, score_s in singles:
            ...
            for name_d, matrix_d, score_d in concepts:
                ...
                name_conj_x = [name_s, name_d,]
                name_conj_y = [name_d, name_s,]
                ...
                # Disjunctive rules
                name_disj_x = [name_d, name_s,]
                name_disj_y = [name_d, name_s,]
        ...
        if write == "True" and depth == 2:
            categories = random.sample(categories, 2200)
            ts.write_matrix_to_file(categories, path_matrix="concepts/matrix_depth_" + str(depth+1), path_names="concepts/names_depth_" + str(depth+1))
