...
def main():
    ...
    categories = read_in_categories("categories/matrix_depth_3")
    names_of_categories = read_in_names("categories/names_depth_3")[:2200]
    egos_of_categories = get_ego_relatives_from_list(categories)[:2200]
